...
走 QQ 开放平台的官方 Bot，可和用户在 QQ 里互动。

## 1. 建 QQ Bot

1. 打开 [QQ Bot 开放平台](https://q.qq.com/qqbot/openclaw/)，用 QQ 登录。
2. **创建 Bot**，一般无需审批；每号最多约 5 个。
...
1. Bot **Platforms** → **Add Channel** → **QQ**。
2. 填 **AppID**、**AppSecret**。
3. 可选：
